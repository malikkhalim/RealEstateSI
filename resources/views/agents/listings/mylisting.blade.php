                    ...
                    <table id="" class="table table-bordered table-responsive-lg">
                        ...
                        <tbody>
                            ...
                            <tr id="row_{{$listing->id}}">
                                ...
                                <td>
                                <a href="{{ route('mylisting.show', $listing -> id ) }}"><span class="btn btn-sm btn-rounded btn-success">View</span></a>

                                {{-- <form style="display:inline-block" method="POST" action="{{ route('mylisting.destroy', $listing -> id) }}">
                                @csrf
                                @method('DELETE')
                                
                            <button  type="submit" class="btn btn-sm btn-rounded btn-danger">Delete</button>
                                </form> --}}
                                <button onclick="deleteData('{{ route('mylisting.destroy', $listing->id) }}', '{{ $listing->id }}')" type="button" class="btn btn-sm btn-rounded btn-danger">Delete</button>
        ...
        @if(count($published_listings) >= 0)
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('mylisting.create') }}"><span class="tr btn btn-sm btn-rounded btn-info">Add Listings</span></a>
                </div>
                <div class="table-responsive m-t-20">
                    <table id="" class="table table-bordered table-responsive-lg">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr id="row_{{$listing->id}}">
                                ...
                                <button onclick="deleteData('{{ route('mylisting.destroy', $listing -> id) }}','{{ $listing -> id }}')" type="submit" class="btn btn-sm btn-rounded btn-danger">Delete</button>
