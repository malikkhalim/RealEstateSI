                ...
                @endif
                    <form action="{{ route('mylisting.store') }}" method="POST" class="form-horizontal m-t-30" enctype="multipart/form-data"> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="Full Name">
                        </div>
                        <div class="form-group">
                            <label>Price :</label>
                            <input type="number" name="price" class="form-control" value="{{ old('price') }}"  placeholder="Price in USD">
                        </div>
                        <div class="form-group">
